        ...
        >
            ...
            >
                <Link href="https://www.codecool.com/" target="_blank" rel="noopener noreferrer">
                    ...
                    >
                        <Image width={100} height={100} src={codecoolLogo} alt="codecool logo"/>
                    </motion.div>
                </Link>
            </motion.div>
            ...
            <div className="flex mt-24 flex-col md:flex-row items-center justify-center md:justify-evenly p-6 md:p-12">
                ...
                <motion.div
                    ...
                    viewport={{once: true}}
                    variants={fadeUp}
                    className="relative w-1/2 md:w-1/3 lg:w-1/4 mt-6 md:mt-0 flex justify-center"
                >
                    <div className="relative w-full">
                        <Image
                            ...
                            src={aboutmeImage}
                            alt="Hero"
                            className="object-cover rounded-3xl border-4 border-gray-800 shadow-xl shadow-[#2BA7FF]/50 transform transition duration-300 hover:scale-105 hover:shadow-color-7/50"
                        />
                    </div>
                </motion.div>
                ...
                <div
                    className="h-[80vh] rounded-2xl items-center flex flex-col text-center md:text-left md:w-1/2 mb-6 md:mb-0">
                    <motion.h1
                        initial="hidden"
                        whileInView="visible"
                        viewport={{once: true}}
                        variants={fadeUp}
                        className="text-3xl glow-text text-center md:text-5xl lg:text-8xl font-bold text-color-5 dark:text-lightGray mb-12 transition-colors duration-500 ease-in-out"
                    >
                        About Me
                    </motion.h1>
                    ...
                    <motion.div
                        ...
                        className="w-full"
                    >
                        <p className="text-xl glow-text font-semibold text-lightGray mb-8">
                            {ABOUTME_MESSAGES[0]}
                        </p>
                    </motion.div>
                    ...
                    >
                        <div></div>
                        <p className="text-xl glow-text font-semibold text-lightGray">
                            {ABOUTME_MESSAGES[2]}
                        </p>
                    </motion.div>

                    <div className="grid grid-cols-2 space-x-24 w-full">
                        <div></div>
                        <Button href={"#contact"}>
                            Contact Me
                        </Button>
            ...
            <div className="absolute -right-14 bottom-0">
                <div className="relative">
                    <Image src={neonPcImage} alt={"cartoonaboutme"} className="object-cover" width={600} height={600}/>

                    <div
                        className="absolute top-[24%] left-[28.6%] -rotate-25 w-[71px] h-[55px] skew-x-[-20deg] skew-y-[-1deg]"
                    >
                        <Image className="rounded-sm" src={hordeImage} alt="monitor1" fill/>
                    </div>

                    <div className="absolute top-[19.1%] left-[41.4%] w-[104px] h-[57px] skew-x-[-1deg]">
                        <Image className="object-cover rounded-sm" src={lakersImage} alt="monitor2" fill/>
                    </div>

                    <div
                        className="absolute top-[24%] left-[59.7%] rotate-[22.5deg] w-[71px] h-[55px] skew-x-[17deg] skew-y-[3deg]">
                        <Image className="rounded-sm" src={nvidiaImage} alt="monitor3" fill/>
                    </div>
                </div>
            </div>
        </section>
