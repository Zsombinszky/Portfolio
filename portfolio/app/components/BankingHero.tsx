...
export const BankingHero: React.FC = () => {
    return (
        <section
            ...
            <div>
                <h2 className="text-6xl text-color-8 mt-24 glow-text-2 font-semibold text-center tracking-tight">Horizon
                    Banking</h2>
                <p className="text-lightGray glow-text-2 text-xl font-semibold tracking-tight text-center my-6">
